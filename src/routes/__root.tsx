...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ME — Hệ thống quản lý trung tâm ngoại ngữ" },
      ...
      { property: "og:title", content: "ME — Hệ thống quản lý trung tâm ngoại ngữ" },
      ...
      { name: "twitter:title", content: "ME — Hệ thống quản lý trung tâm ngoại ngữ" },
